...
@available(iOS 14.0, *)
public struct CC_BY_SA_3_0: View {
    ...
    public var body: some View {
        List {
            Section {
                Text("Attribution-ShareAlike 3.0 Unported")
                Text("""
